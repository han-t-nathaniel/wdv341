...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$row = $stmt->fetch()) {
        ...
        $mainContentOutput = $queryResultOutput;
    }
} else {
...
<html lang="en">
    <head>
        ...
        <title>WDV 341 | 11-1: Self Posting Input Event form with INSERT</title>
    ...
    <body onload="themeLoad()">
        ...
        <main>
            <h1>WDV 341 | 11-1: Self Posting Input Event form with INSERT</h1>
            <p><?= $mainContentOutput; ?></p>
        </main>
    </body>
</html>